...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmployeesByTitle = channel.unary_unary(
                ...
                request_serializer=EmployeeService__pb2.EmployeeTitleRequest.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                _registered_method=True)
        self.GetEmployeesByName = channel.unary_unary(
                '/employee_service.EmployeeService/GetEmployeesByName',
                request_serializer=EmployeeService__pb2.EmployeeNameRequest.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                _registered_method=True)
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetEmployeesByTitle': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=EmployeeService__pb2.EmployeeTitleRequest.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
            'GetEmployeesByName': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeesByName,
                    request_deserializer=EmployeeService__pb2.EmployeeNameRequest.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
    }
...
class EmployeeService(object):
    ...
    def GetEmployeesByTitle(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/employee_service.EmployeeService/GetEmployeesByTitle',
            EmployeeService__pb2.EmployeeTitleRequest.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def GetEmployeesByName(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/employee_service.EmployeeService/GetEmployeesByName',
            EmployeeService__pb2.EmployeeNameRequest.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options,
            channel_credentials,
            insecure,
